...
namespace NetworkCall
{
    ...
    "Yemen","Yugoslavia","Zambia","Zimbabwe"
        ...
        ListView lstDataList;
        ArrayAdapter<string> countryDataAdapter;
        protected override void OnCreate(Bundle savedInstanceState)
        {
            base.OnCreate(savedInstanceState);
            SetContentView(Resource.Layout.DataListActivity);
            // Create your application here

            countryDataAdapter = new ArrayAdapter<string>(this, Android.Resource.Layout.SimpleListItem1, countries);

            lstDataList = FindViewById(Resource.Id.listView1) as ListView;

            lstDataList.Adapter = countryDataAdapter;
